...
//! }
//!
//! let char_pos = CharOffset::new(5);
//! let byte_pos = ByteOffset::new(10);
//!
//! process_span(char_pos, CharOffset::new(10));  // OK
//! // process_span(byte_pos, CharOffset::new(10));  // Compile error!
//! ```
