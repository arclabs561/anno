...
Total: 12 | ✓: 8 | ⊘: 0 | ✗: 4 | Avg examples: 13 | Avg time: 2029ms
...
| Named Entity Recognition | CoNLL2002 | heuristic | Failed to load dataset: Invalid input: Downloaded HTML from https://huggingface.co/datasets/eriktks/conll2002. This URL looks like a webpage, not a raw dataset file. |
| Named Entity Recognition | CoNLL2002 | stacked | Failed to load dataset: Invalid input: Downloaded HTML from https://huggingface.co/datasets/eriktks/conll2002. This URL looks like a webpage, not a raw dataset file. |
...
- [3x] Failed to load dataset: Invalid input: Downloaded ...
...
|---------|---------|----|----|----|---|----|
| WikiGold | bert_onnx | 75.2 | 72.1 | 78.6 | 20 | 354 |
...
| WikiGold | stacked | 49.6 | 44.9 | 55.4 | 20 | 357 |
...
| Wnut17 | bert_onnx | 18.2 | 16.7 | 20.0 | 20 | 422 |
...
| Wnut17 | stacked | 6.3 | 4.5 | 10.0 | 20 | 449 |
...
| CoNLL2003Sample | stacked | 0.0 | 0.0 | 0.0 | 1 | 13728 | (stacked: incompatible types)
...
| CoNLL2003Sample | bert_onnx | 0.0 | 0.0 | 0.0 | 1 | 924 |
...
| CoNLL2002 | heuristic | ✗ | load-failed | - |
| CoNLL2002 | stacked | ✗ | load-failed | - |
...
|---------|---|---|---|--------|
| stacked | 3 | 0 | 1 | 18.6 |
| bert_onnx | 3 | 0 | 1 | 31.1 |
| heuristic | 2 | 0 | 2 | 14.7 |
