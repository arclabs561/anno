...
fn business_domain() -> Vec<RelationExample> {
    vec![
        RelationExample {
            text: "Tesla, led by Elon Musk, manufactures cars in Fremont.".to_string(),
            relations: vec![
                RelationGold::new(
                    (14, 23), "PER", "Elon Musk",
                    (0, 5), "ORG", "Tesla",
...
fn scientific_domain() -> Vec<RelationExample> {
    vec![
        RelationExample {
            ...
            relations: vec![
                RelationGold::new(
                    (24, 39), "PER", "Jennifer Doudna",
                    (0, 6), "MISC", "CRISPR",
                    "DEVELOPED",
                ),
                RelationGold::new(
                    (24, 39), "PER", "Jennifer Doudna",
                    (43, 54), "ORG", "UC Berkeley",
                    "AFFILIATED_WITH",
                ),
            ],
            difficulty: Difficulty::Medium,
        ...
        RelationExample {
            text: "Einstein published the theory of relativity while at the Swiss Patent Office.".to_string(),
            relations: vec![
                RelationGold::new(
                    (0, 8), "PER", "Einstein",
                    (23, 44), "MISC", "theory of relativity",
                    "AUTHORED",
                ),
                RelationGold::new(
                    (0, 8), "PER", "Einstein",
                    (58, 77), "ORG", "Swiss Patent Office",
                    "WORKS_FOR",
                ),
            ],
            difficulty: Difficulty::Medium,
...
fn biography_domain() -> Vec<RelationExample> {
    vec![
        ...
        RelationExample {
            ...
            relations: vec![
                RelationGold::new(
                    (0, 11), "PER", "Marie Curie",
                    (16, 28), "PER", "Pierre Curie",
                    "SPOUSE_OF",
                ),
            ],
            difficulty: Difficulty::Medium,
